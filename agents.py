...
class MeetingPrepAgents:
    def __init__(self):
        self.toolset = ExaSearchToolset()

    def research_agent(self):
        return Agent(
            role="Research Specialist",
            goal='Conduct thorough research on people and companies involved in the meeting',
            tools=self.toolset.tools(),  # Ensure tools are correctly passed
            backstory=dedent("""\
    ...
    def industry_analysis_agent(self):
        return Agent(
            ...
            tools=self.toolset.tools(),  # Ensure tools are correctly passed
            backstory=dedent("""\
            As an Industry Analyst, your analysis will identify key trends, challenges facing the 
            industry, and potential opportunities that could be leveraged during the meeting for strategic
            advantage."""),
            verbose=True
        )
    ...
    def summary_and_briefing_agent(self):
        return Agent(
            ...
            tools=self.toolset.tools(),  # Ensure tools are correctly passed
            backstory=("""\
            As the Briefing Coordinator, your role is to consolidate the research, analysis, and
            strategic insights."""),
            verbose=True
        )
